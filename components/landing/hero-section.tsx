        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Link href="/dashboard">
                <Button className="bg-linear-to-r from-blue-500 to-cyan-500 text-white border-0 hover:shadow-lg hover:shadow-blue-500/50 transition-all h-12 px-8 text-base">
            ...
            <div className="flex items-center gap-2 text-white/50 text-sm">
              <div className="flex -space-x-2">
                ...
                <div className="h-6 w-6 rounded-full bg-linear-to-br from-purple-400 to-pink-400" />
                <div className="h-6 w-6 rounded-full bg-linear-to-br from-green-400 to-emerald-400" />
              </div>
